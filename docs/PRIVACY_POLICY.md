...
Coffee Break is developed by [DEVELOPER / COMPANY NAME]. Contact:
[SUPPORT EMAIL].
...
- **Game progression data**: unlocked levels, XP, and in-game currency
...
- If you never connect an account, uninstalling the app deletes your local
  progress; we do not retain a copy tied to your device once you stop
  using it. [Confirm/adjust once actual server retention policy is
  decided.]
- If you connect an account, your data is retained until you request
  deletion — contact [SUPPORT EMAIL].
...
We may update this policy; changes will be posted at this URL with an
updated date above.
